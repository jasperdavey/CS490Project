...
result=`curl --request POST $url --data 'json={"command":1,"email":"hello@test.edu","password":"randompassword","username":"jaspy123","firstname":"Jasper","lastname":"Davey","bio":"I like CS","events":{},"tags":{}}'`
