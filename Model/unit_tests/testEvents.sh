...
result=`curl --request POST $url --data 'json={"command":3,"name":"ACM","bio":"Event for CS students","startDateTime":"2016-04-30 12:00:00","endDateTime":"2016-04-30 13:00:00","location":"GITC 2000","tags":{"#CS":2,"#ComputerScience":5,"#NJIT":7},"owner":28}'`
