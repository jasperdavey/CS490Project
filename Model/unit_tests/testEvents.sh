...
result=`curl --request POST $url --data 'json={"command":3,"name":"IEEE","bio":"Event for CS students","dateAndTime":"12:00:00PM 4-30-2016","location":"GITC 2000","tags":{"#Electrical":2,"#Engineering":5,"#NJIT":7}}'`
echo "${result}"
