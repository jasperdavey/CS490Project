...
elseif(!isset($info['email']) || empty($info['email'])){
	$response['status'] = 404;
	$response['message'] = "Error: email empty.";
	...
	$query = mysql_query("UPDATE Users SET email = '".$info['email']."' WHERE id = '".$info['id']."';", $connection);
