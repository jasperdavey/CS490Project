...
FileName: updateUserFirstname.php		   	*
By:       Angelica Llerena					*
Date:     April 10, 2016.					*
*********************************************/
...
elseif(!isset($info['firstname']) || empty($info['firstname'])){
	$response['status'] = 404;
	$response['message'] = "Error: firstname empty.";
	...
	$query = mysql_query("UPDATE Users SET firstname = '".$info['firstname']."' WHERE id = '".$info['id']."';", $connection);
